...
def random_value(prop, generated_property_values):
    print("\033[94m => Generating random value for property: \033[0m", prop)
    ...
    if random_value is not None:
        print("\033[94m => => Random value generated by Faker: \033[0m", random_value)
    ...
    try:
        ...
        if prop in generated_property_values:
            ...
            print(
                "\033[94m => => Using random value previously generated by ChatGPT: \033[0m",
                random_value,
            )
            return random_value, new_generated_property_values
        ...
        traceback.print_exc()
        print("\033[93m => => Using Faker...\033[0m")

    if random_value is not None:
        print("\033[94m => => Random value generated by ChatGPT: \033[0m", random_value)
        return random_value, new_generated_property_values
    else:
