...
SENTENCES_TEXT_FILE = "./data/sentences.txt"
...
# 配置每个用例的生成上限
TEXT2JSON_EQUAL_LIMIT = 50000
TEXT2JSON_REDUCE_LIMIT = 50000

# 配置每个用例的生成上限
JSON2JSON_REDUCE_BY_NAME_LIMIT = 50000
JSON2JSON_REDUCE_BY_JSON_LIMIT = 50000

# 配置每个用例的生成上限
TEXT2TABLE_EQUAL_LIMIT = 50000
TEXT2TABLE_REDUCE_LIMIT = 50000
